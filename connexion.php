...
<body>
    <h1> Connexion </h1>
    <p> Bienvenue sur le site lie au projet Smart Impact, pour en voir plus, merci de vous connecter. Si vous n'êtes par encore connecté, <a href="./inscription.php"> inscrivez-vous </a>.</p>
    <?php
    ...
    <form method="POST" action="connexion.php">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <label for="connexion">Memoriser mes identifiants </label>
            </div>
            <div class="form-group col-md-6">
